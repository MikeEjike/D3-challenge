...
Using the D3 techniques, created a scatter plot that represents each state with circle elements, including the state abbreviations, in the `app.js` file, pulling in the data from `data.csv` by using the `d3.csv` function.
